...
public class Choose3Players implements Screen{
	...
	public Choose3Players(Heckmeck gam) {
		game = gam;
	    ...
	    //-----------------
		 TextButtonStyle s= game.getButtonStyle();
			...
			public void changed(ChangeEvent event, Actor actor) {
				game.board.pocetHracov=3;
				game.board.preparePlayers(1,2);
				game.setScreen(new PlayGround(game, game.stage));
				dispose();				
			}
		    };
		    TextButton button= game.createButton("One Player vs Two Bots", s, 50,200, cListener);
		    
		    ChangeListener cListener2 = new ChangeListener() {
				@Override
				public void changed(ChangeEvent event, Actor actor) {
					game.board.pocetHracov=3;
					game.board.preparePlayers(2,1);
					game.setScreen(new PlayGround(game, game.stage));
					dispose();				
				}
			    };
			    TextButton button2= game.createButton("Two Players vs One Bot", s, 50,200, cListener2);
			    
			    ChangeListener cListener3 = new ChangeListener() {
					@Override
					public void changed(ChangeEvent event, Actor actor) {
						game.board.pocetHracov=3;
						game.board.preparePlayers(3,0);
						game.setScreen(new PlayGround(game, game.stage));
						dispose();				
					}
				    };
				    TextButton button3= game.createButton("Three Players", s, 50,200, cListener3);
				...
				TextButton button4= game.createButton("Back", s, 50,200, cListener4);
				  ...
				  //---------------
				    ...
				    button.setPosition(230, 210);
				    stage.addActor(button2);
				    button2.setPosition(230, 150);
				    stage.addActor(button3);
				    button3.setPosition(230, 90);
				    stage.addActor(button4);
				    button4.setPosition(230, 30);
