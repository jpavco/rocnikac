...
public class SinglePlayerMenu implements Screen {
	...
	public SinglePlayerMenu(Heckmeck gam) {
		game = gam;
	    ...
	    TextButton button= game.createButton("Normal Mode", s, 50,150, cListener);
	    
	    ChangeListener cListener2 = new ChangeListener() {
			@Override
			public void changed(ChangeEvent event, Actor actor) {
				System.out.println("Toto bude ten humus");	
					
			}
		    };
		TextButton button2= game.createButton("Real Mode", s, 50,150, cListener2);
